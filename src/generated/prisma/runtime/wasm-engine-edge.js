  ...
  mn = (t, e, r, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of es(e))
        !rs.call(t, i) &&
          i !== r &&
          kt(t, i, { get: () => e[i], enumerable: !(n = Zo(e, i)) || n.enumerable });
    return t;
  };
var it = (t, e, r) => (
    (r = t != null ? Xo(ts(t)) : {}),
        ...
        r < 4
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                f ||
                (r == 6 && (n > 0 ? (i > 0 ? h / Oe(10, s - i) : 0) : A[C - 1]) % 10 & 1) ||
                r == (t.s < 0 ? 8 : 7))))),
    e < 1 || !A[0])
  )
    return (
  ...
  xn = ie(() => {
    ...
    S.toDecimalPlaces = S.todp = function (t, e) {
      ...
      return (
        ...
        t === void 0
          ? r
          : (ce(t, 0, Ue), e === void 0 ? (e = n.rounding) : ce(e, 0, 8), L(r, t + j(r) + 1, e))
      );
    };
    ...
    he = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          f = n.e - i.e, se = B.length, Se = le.length, R = new Ot(Yo), _ = R.d = [], h = 0;
          B[h] == (le[h] || 0);
...
var Sr,
  ...
  Sn = !0;
typeof g < "u" &&
  (({ FORCE_COLOR: Sr, NODE_DISABLE_COLORS: Cn, NO_COLOR: An, TERM: Rn } = g.env || {}),
...
function bs(t) {
  let e = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Ft.push([o, ...n]), Ft.length > ys && Ft.shift(), st.enabled(o) || i)
      ) {
...
function $t(t) {
  let e = t.showColors ? ia : oa,
    r;
  return (
    typeof $getTemplateParameters < "u" ? (r = $getTemplateParameters(t, e)) : (r = sa(t)),
    aa(r, e)
  );
}
u();
...
function ua(t) {
  ...
  for (let n of t) {
    ...
    o
      ? e.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: ca(o.argument.typeNames, n.argument.typeNames) },
        })
      : e.set(i, n);
  }
...
var Ki = (t) => (Array.isArray(t) ? t : t.split(".")),
  ...
  Hi = (t, e, r) =>
    Ki(e).reduceRight((n, i, o, s) => Object.assign({}, Xr(t, s.slice(0, o)), { [i]: n }), r);
function rl(t, e) {
